...
public class MarkovActionBarContributor extends EditingDomainActionBarContributor implements ISelectionChangedListener {
    ...
    protected IAction showPropertiesViewAction = new Action(
        ...
        public void run() {
            try {
                MarkovActionBarContributor.this.getPage().showView("org.eclipse.ui.views.PropertySheet");
    ...
    protected IAction refreshViewerAction = new Action(
        ...
        public boolean isEnabled() {
            return MarkovActionBarContributor.this.activeEditorPart instanceof IViewerProvider;
        }

        @Override
        public void run() {
            if (MarkovActionBarContributor.this.activeEditorPart instanceof IViewerProvider) {
                final Viewer viewer = ((IViewerProvider) MarkovActionBarContributor.this.activeEditorPart).getViewer();
                if (viewer != null) {
                    viewer.refresh();
                }
            }
    ...
    public void contributeToMenu(final IMenuManager menuManager) {
        ...
        final IMenuManager submenuManager = new MenuManager(
                MarkovEditorPlugin.INSTANCE.getString("_UI_MarkovEditor_menu"),
                "org.palladiosimulator.reliability.markovMenuID");
        ...
        this.createChildMenuManager = new MenuManager(
                MarkovEditorPlugin.INSTANCE.getString("_UI_CreateChild_menu_item"));
        submenuManager.insertBefore("additions", this.createChildMenuManager);

        // Prepare for CreateSibling item addition or removal.
        //
        this.createSiblingMenuManager = new MenuManager(
                MarkovEditorPlugin.INSTANCE.getString("_UI_CreateSibling_menu_item"));
