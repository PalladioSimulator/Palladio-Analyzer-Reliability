...
/**
 * This is the item provider adapter for a {@link org.palladiosimulator.reliability.markov.Entity}
...
public class EntityItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
    ...
    protected void addNamePropertyDescriptor(final Object object) {
        this.itemPropertyDescriptors.add(this
                .createItemPropertyDescriptor(((ComposeableAdapterFactory) this.adapterFactory).getRootAdapterFactory(),
                        this.getResourceLocator(), this.getString("_UI_Entity_Name_feature"),
                        this.getString("_UI_PropertyDescriptor_description", "_UI_Entity_Name_feature",
                                "_UI_Entity_type"),
                        MarkovPackage.Literals.ENTITY__NAME, true, false, false,
    ...
    public Object getImage(final Object object) {
        return this.overlayImage(object, this.getResourceLocator().getImage("full/obj16/Entity"));
    }
